...
showWin: function(width, height, title, src) {
        ...
        inntHtml += '<div id="maskTop" style="width: ' + width + 'px; height: ' + height + 'px; border: #999999 1px solid; background: #fff; color: #333; position: absolute; top: 0; left: 50%; margin-left: -' + marginLeft + 'px; margin-top: 60px;' + ' z-index: 9999; filter: progid:DXImageTransform.Microsoft.Shadow(color=#909090,direction=120,strength=4); -moz-box-shadow: 2px 2px 10px #909090; -webkit-box-shadow: 2px 2px 10px #909090; box-shadow: 2px 2px 10px #909090;">'
        inntHtml += '<div id="maskTitle" style="height: 50px; line-height: 50px; font-family: HelveticaNeue-Lt; font-size: 14px; color: #333333; padding-left: 20px; background-image: url(data:image/png;base64,); border-bottom: 1px solid #999999; position: relative;">'
        inntHtml += '' + title + ''
        ...
        inntHtml += '</div>'
        inntHtml += '<iframe width="' + iframeWidth + '" height="' + iframeHeight + '" frameborder="0" scrolling="' + this.scrolling + '" src="' + src + '"></iframe></div>';
...
showPop: function(width, height, title, src) {
    var iframeHeight = height - 52;
    var marginLeft = width / 2;
    var marginTop = height / 2;
    var iframeWidth = width-2;
    var inntHtml = '';
    inntHtml += '<div id="mask" style="width:100%; height:100%; position:fixed; top:0; left:0; z-inde:1999;background:#333333; filter:alpha(opacity=80); -moz-opacity:0.8; -khtml-opacity: 0.8; opacity:0.8;"></div>'
    inntHtml += '<div id="maskTop" style="width: ' + width + 'px; height: ' + height + 'px; border: #999999 1px solid; background: #fff; color: #333; position: fixed; top: 50%; left: 50%; margin-left: -' + marginLeft + 'px; margin-top: -' + marginTop + 'px; z-index: 2999; filter: progid:DXImageTransform.Microsoft.Shadow(color=#909090,direction=120,strength=4); -moz-box-shadow: 2px 2px 10px #909090; -webkit-box-shadow: 2px 2px 10px #909090; box-shadow: 2px 2px 10px #909090;">'
    inntHtml += '<div id="maskTitle" style="height: 40px; line-height: 40px; font-family: Microsoft Yahei; font-size: 14px; color: #999999; padding-left: 20px; background-color: #f9f9f9; border-bottom: 2px solid #e3e3e3; position: relative;">'
    inntHtml += '' + title + ''
    inntHtml += '<div id="popWin2Close" style="width: 20px; height: 20px; cursor: pointer; position: absolute; top: 10px; right: 10px; background-image: url(/public/images/icons/close.png);"></div>'
    inntHtml += '</div>'
    inntHtml += '<iframe width="' + iframeWidth + '" height="' + iframeHeight + '" frameborder="0" scrolling="' + this.scrolling + '" src="' + src + '"></iframe>';
...
function showPop(title,content, button1, button2, yesCallback, noCallback)
{
	var numargs = arguments.length;
	var expargs = showPop.length;  
	for (i = 0 ; i <= numargs; i++){  
		showPop[i] = arguments[i];
	}
	  
	var popBox = '<div id="pop-mask"></div><div id="pop-box"><div id="pop-box-close" onclick="closePop();"></div>';
	popBox += '<p class="pop-box-title">'+title+'</p>';
	popBox += '<p class="pop-box-content">'+content+'</p><div class="ad-line"></div>';
	popBox += '<div class="text-left"><button id="btn-yes" class="btn btn-green btn-lg btn-pad-lg">'+button1+'</button>';
	if(button2){
		popBox += '<button id="btn-no" class="btn btn-gray btn-lg btn-pad-lg">'+button2+'</button>';
	}
	popBox += '</div></div>'; 
	$('body').append(popBox);
	
	 if (typeof(yesCallback) == 'function'){
		  $('#btn-yes').click(yesCallback);
	 } 
	 
	 if (typeof(noCallback) == 'function'){
		  $('#btn-no').click(noCallback);
	 } 
}
